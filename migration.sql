...
<p>Hayır. DASK SADECE bina hasarlarını ve sadece deprem (ve sonrası yangın, infilak, tsunami) riskini kapsar. Eşyalarınız, yangın, sel, hırsızlık DASK kapsamında değildir. Bunlar için ayrıca <a href="/v2/urun/konut-sigortasi">Konut Sigortası</a> yaptırılmalıdır.</p>
<p>Mizan Sigorta olarak DASK + Konut Sigortası birlikte yapıldığında özel indirimler sunuyoruz. <a href="/v2/teklif">Teklif almak için tıklayın</a>.</p>', 'Konut Sigortası', 'dask, zorunlu deprem, konut sigortası, tapu, prim', 'DASK Zorunlu mu? Yaptırmamanın Cezası Var mı? - Mizan Sigorta', 'DASK (Doğal Afet Sigortaları Kurumu) zorunlu deprem sigortası kimler için zorunlu, hangi durumlarda yaptırılması şart? Tapu işlemlerinde DASK’ın rolünü inceliyoruz.', NOW(), 1);
...
<p>Mizan Sigorta olarak 8+ farklı sigorta şirketinin tamamlayıcı sağlık ürünlerini karşılaştırmalı olarak sunuyoruz. <a href="/v2/teklif">Hızlı teklif alın</a>.</p>', 'Sağlık Sigortası', 'tamamlayici saglik, sgk, ozel saglik, fark ucreti', 'Tamamlayıcı Sağlık Sigortası Nedir? Özel Sağlıktan Farkı? - Mizan Sigorta', 'SGK’lı çalışanlar için ekonomik özel sağlık çözümü olan tamamlayıcı sağlık sigortasını tanıyalım. Özel sağlık sigortasından farkları, avantajları ve kimler için uygun olduğunu anlatıyoruz.', NOW(), 1);
